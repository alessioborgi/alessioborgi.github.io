...
- Borgi, A., Severino, M., Silvestri, F., & Liò, P. (2026). [Equivariant Sheaf Neural Networks: Learning Geometric Transport on Graphs](https://arxiv.org/abs/2608.28853). *arXiv:2608.28853* (learns directed, matrix-valued transport between vector stalks under exact ambient $$E(n)$$-equivariance, with a completeness theorem for displacement-conditioned transport, covered in depth in [this dedicated post](/blog/sheaf/equivariant-sheaf-neural-networks/)).
