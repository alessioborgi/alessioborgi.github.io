...
- Zaghen, O., Longa, A., Azzolin, S., Telyatnikov, L., Passerini, A., & Liò, P. (2024). [Sheaf Diffusion Goes Nonlinear: Enhancing GNNs with Adaptive Sheaf Laplacians](https://arxiv.org/abs/2410.11390). *ICML 2024 Workshop on Geometry-grounded Representation Learning and Generative Modeling*.
