...
<p style="margin-bottom:0.5rem;">
  <a class="btn" href="{{ '/Z-SASLM.github.io-main/index.html' | relative_url }}" target="_blank" rel="noopener">Open full-page view →</a>
</p>
<iframe
  src="{{ '/Z-SASLM.github.io-main/index.html' | relative_url }}"
  style="width: 100%; min-height: 2400px; border: 1px solid #dfe3eb; border-radius: 12px; overflow: hidden;"
  loading="lazy"
